...
% Last Modified by GUIDE v2.5 25-Aug-2017 23:30:16
...
conn.Message;
% msgbox('Successfully Data is Saved 'edit1);

% a='world';
% msgbox(sprintf(' hello %s', a))

username =get(handles.edit1,'String');
password =get(handles.edit2,'String');

sqlquery = sprintf('select count(*)as count from tbl_login where username=%s and password=%s', username, password);
